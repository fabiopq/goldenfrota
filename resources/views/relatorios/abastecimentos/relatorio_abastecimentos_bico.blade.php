                        ...
                        <tbody>
                            @foreach($bico->abastecimentos as $abastecimento)
                                ...
                                <tr>
                                    ...
                                    <td align="right"> {{ number_format($abastecimento->encerrante_inicial, 2, ',', '.') }}
                                    </td>
                                    <td align="right"> {{ number_format($abastecimento->encerrante_final, 2, ',', '.') }} </td>
                                    <td align="right"> {{ number_format($abastecimento->volume_abastecimento, 3, ',', '.') }}
                                    </td>
                                    <td align="right"> {{ number_format($abastecimento->valor_litro, 3, ',', '.') }} </td>
                                    <td align="right"> {{ number_format($abastecimento->valor_abastecimento, 3, ',', '.') }}
                                    </td>
                                </tr>
    ...
    <table class="table table-sm report-table">
        <tbody>
            <tr class="default">
                ...
                <td align="right">
                    <h5>Quantidade Abastecida: {{ number_format($qtdTotal, 3, ',', '.') }}</h5>
                </td>
                <td align="right">
                    <h5>Valor Abastecido: {{ number_format($vlrTotal, 3, ',', '.') }}</h5>
                </td>
            </tr>
        </tbody>
    </table>
