                                                ...
                                                <tbody>
                                                    @foreach($departamento->abastecimentos as $abastecimento)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                {{ number_format($abastecimento->valor_litro, 3, ',', '.') }} </td>
                                                            <td align="right">
                                                            ...
                                                            <td align="right">
                                                                {{ number_format($abastecimento->km_veiculo, 1, ',', '.') }} </td>
                                                            <td align="right">
                                                ...
                                                @foreach($clientesNulloAnalitico as $clienteItem)
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                {{ number_format($clienteItem->valor_litro, 3, ',', '.') }} </td>
                                                            <td align="right">
                                                            ...
                                                            <td align="right">
                                                                {{ number_format($clienteItem->km_veiculo, 1, ',', '.') }} </td>
                                                            <td align="right">
                                                                {{ number_format($clienteItem->media_veiculo, 2, ',', '.') }} </td>
                                                        </tr>
                                                @endforeach
                                                <tr class="success">
                                                    <td colspan=2>Total do Departamento</td>
