...
@section('content')
    <div class="card m-0 border-0">
        @component('components.form', [
            ...
            'routeUrl' => route('relatorio_movimentacao_combustivel'), 
            'formTarget' => '_blank',
            'method' => 'POST',
            'formButtons' => [
            ...
            @section('formFields')
                ...
                @component('components.form-group', [
                    'inputs' => [
                        ...
                        [
                            'type' => 'select',
                            'field' => 'tipo_movimentacao_combustivel_id',
                            'label' => 'Tipo de Movimentação',
                            'items' => $tipoMovimentacaoCombustivel,
                            'displayField' => 'tipo_movimentacao_combustivel',
                            'liveSearch' => true,
                            'keyField' => 'id',
                            'disabled' => false,
                            'defaultNone' => true,
