...
Route::middleware(['auth:web'])->group(function () {
    ...
    Route::resource('/ticket_prioridade', 'TicketPrioridadeController')->except('show');
    Route::resource('/ticket_status', 'TicketStatusController')->except('show');
    ...
    Route::resource('/veiculo_status', 'VeiculoStatusController')->except('show');
    ...
    Route::resource('/autorizacao', 'AutorizacaoController')->except('show');
